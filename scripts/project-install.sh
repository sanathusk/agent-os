...
#     local existing_standards="$PROJECT_DIR/better-agents/standards"
...
#     ensure_dir "$PROJECT_DIR/better-agents"
#     ensure_dir "$PROJECT_DIR/better-agents/standards"

#     print_success "Created better-agents/ directory structure"
# }
...
#     local project_standards="$PROJECT_DIR/better-agents/standards"
...
#     local standards_dir="$PROJECT_DIR/better-agents/standards"
#     local index_file="$standards_dir/index.toml"
...
#             print_success "Updated index.toml ($entry_count entries, $new_count new)"
#         else
#             print_success "Updated index.toml ($entry_count entries)"
#         fi
#     else
#         print_success "Created index.toml (no standards to index)"
#     fi
# }
...
#     local commands_source="$BASE_DIR/commands/better-agents"
#     local commands_dest="$PROJECT_DIR/.claude/commands/better-agents"
...
#     if [[ "$count" -gt 0 ]]; then
#         print_success "Installed $count commands to .claude/commands/better-agents/"
#     else
